...
function UpdateHospitalComponent() {
  ...
  const { idHospitalToUpdate } = useParams()
  const [Hospital, setHospital] = useState({})
  const [HospitalPasswordUpdate, setHospitalPasswordUpdate] = useState({})
  const [succesShowPassword, setsuccesShowPassword] = useState(false)
                ...
                <form>
                  <div className="card-body">
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        ...
                        <input className="form-control" type="text" name="HospitalName" value={HospitalName} onChange={(e) => handleChange(e)} required onBlur={() => setRequiredHospital(/^\s*$/.test(Hospital.HospitalName))} />
                        {RequiredHospital && (
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input className="form-control" type="text" name="HospitalAddress" value={HospitalAddress} onChange={(e) => handleChange(e)} required onBlur={() => setRequiredAddress(/^\s*$/.test(Hospital.HospitalAddress))} />
                          {RequiredAddress && (
                            <Alert variant="danger" className="mt-1">
                              <div
                                className="form-icon-wrapper"
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input className="form-control" type="text" name="PhoneNumber" value={PhoneNumber} onChange={(e) => handleChange(e)} onBlur={() => { SetphoneNumberErrorMessage(!/^\d{8}$/.test(Hospital.PhoneNumber)); setRequiredPhone(/^\s*$/.test(Hospital.PhoneNumber)) }} required />
                    ...
                    <div className="row">
                      <div className="col-md-12">
                        <div className="form-group">
                          ...
                          <input className="form-control" type="email" placeholder="jesse@example.com" value={AdminEmail} name="AdminEmail" onChange={(e) => handleChange(e)} onBlur={() => { SetemailErrorMessage(!/^Admin\.[a-zA-Z0-9]+@gmail\.com$/.test(Hospital.AdminEmail)); setRequiredEmail(/^\s*$/.test(Hospital.AdminEmail)) }} required />
                          {RequiredEmail && (
                  ...
                  <div className="card-footer pb-0">
                    <div className="d-flex align-items-center">
                      <Button variant="primary" onClick={() => UpdateHospital()} >
                        <FontAwesomeIcon icon={faPlus} /> Update Hospital
                      </Button>
                      {succesShow && (
              ...
              <div className="card ">
                <form>
                  <div className="card-body">
                    ...
                    <p className="text-uppercase text-sm">reset password</p>
                      
                      <div className="col-md-12">
                        <div className="form-group">
                          <label htmlFor="example-text-input" className="form-control-label">Old Password</label>
                          <input className="form-control" type="password" name="OldPasswordAdmin" onChange={(e) => handleChangePassword(e)} onBlur={() => {setRequiredOldPassword(/^\s*$/.test(HospitalPasswordUpdate.OldPasswordAdmin)) }} required />
                          {RequiredOldPassword && (
                            <Alert className="form-group mt-1" variant="danger">
                              <div
                                className="form-icon-wrapper  "
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          <label htmlFor="example-text-input" className="form-control-label">New Password</label>
                          <input className="form-control" type="password" name="PasswordAdmin" onChange={(e) => handleChangePassword(e)} onBlur={() => { SetpasswordErrorMessage(! /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*()_+])(?=.{8,})/.test(HospitalPasswordUpdate.PasswordAdmin)); setRequiredPassword(/^\s*$/.test(HospitalPasswordUpdate.PasswordAdmin)) }} required />
                          {RequiredPassword && (
                            <Alert className="form-group mt-1" variant="danger">
                              <div
                                className="form-icon-wrapper  "
                      ...
                      <div className="col-md-12">
                        <div className="form-group">
                          ...
                          <input className="form-control" type="password" name="confirmPasswordAdmin" onChange={(e) => handleChangePassword(e)} onBlur={() => { SetconfirmPasswordErrorMessage(HospitalPasswordUpdate.PasswordAdmin !== HospitalPasswordUpdate.confirmPasswordAdmin); setRequiredConfirm(/^\s*$/.test(HospitalPasswordUpdate.confirmPasswordAdmin)) }} required />
                          {RequiredConfirm && (
                            <Alert className="form-group mt-1" variant="danger">
                              <div
                                className="form-icon-wrapper  "
                      ...
                      <div className="col-md-6">
                        <Button variant="primary" onClick={() =>updatePasswordHospital() } style={{ height: "30px", fontSize: "14px" }}>
                          <FontAwesomeIcon icon={faPlus} /> Save Changes
                        </Button>
                        {succesShowPassword && (
